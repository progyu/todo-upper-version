...
var $ckAll = document.querySelector('#ck-complete-all');
var $delBtn = document.querySelector('.btn');
var $nav = document.querySelector('.nav');
var navState = 'all';

function countCompletedTodos() {
  document.querySelector('.completed-todos').innerText = todos.filter(function (todo) {
    return todo.completed;
  }).length;
}

function countUncompletedTodos() {
  document.querySelector('.active-todos').innerText = todos.filter(function (todo) {
    return !todo.completed;
  }).length;
}
...
$todos.onclick = function (e) {
  ...
  fetch("/todos/".concat(+e.target.parentNode.id), {
    method: 'DELETE'
  }).then(function (res) {
    return res.json();
  }).then(render)["catch"](console.error);
...
$nav.addEventListener('click', function (e) {
  ...
  navState = e.target.id; // fetch(`/todos/${navState}`)
  //   .then(res => res.json())
  //   .then(render)
  //   .catch(console.error);
